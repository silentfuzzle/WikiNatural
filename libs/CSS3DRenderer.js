...
THREE.CSS3DRenderer = function () {
    ...
    this.domElement.id = 'render_element';
    this.domElement.isContentEditable = true;
    ...
    this.cameraElement.id = 'camera_element';
    this.cameraElement.isContentEditable = true;
    ...
    this.getFOV = function ( camera ) {
        return 0.5 / Math.tan( THREE.Math.degToRad( camera.fov * 0.5 ) ) * _height;
    }

	this.render = function ( scene, camera ) {

        var fov = this.getFOV(camera);
